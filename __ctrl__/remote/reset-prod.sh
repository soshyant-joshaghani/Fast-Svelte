...
for vol in fast-svelte_db-data fast-svelte_redis-data; do
...
echo
echo "Free build cache: bash __ctrl__/remote/prune-docker-build.sh"
echo "Start fresh:      bash __ctrl__/remote/start-prod.sh"
